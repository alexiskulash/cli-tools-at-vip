...
## Save all the ID and title of all posts as CSV into post_ids.csv
...
```bash
$ vip @297.testing -- wp post list --format=csv
--fields=ID,post_title --posts_per_page=10
```
...
ID,post_title
1807,"Test Post22233"
1791,"Hello Test 1 2 3 Test"
1789,"Testing 1 2 3"
1786,Testestsetsetst
1784,"Another Test Post"
1782,"Testing Post"
1781,"Testing 1 2 3"
1750,"hello hello hello"
1746,"Thgere are GEESE in the wild !"
1744,"There are bears in the wild !"
```
...
## Using `vip`, get the value cached for the key `"alloptions"` in the `"options"` group
